// This one differs from English due to number formatting and some dynamic text.
...
function updateValueLabels(retirementAge,buybackYears,buybackDollars,buybackIncrease,buybackFrequency) {
   ...
   if (buybackFrequency == 12) {
      $('#buybacksummary-increase-label').text('Augentation de rente mensuelle');
      $('#table-details-header').text('Impact sur vortre rente mensuelle');
   } else {
      $('#buybacksummary-increase-label').text('Augentation de rente annuelle');
      $('#table-details-header').text('Impact sur vortre rente annuelle');
   }
