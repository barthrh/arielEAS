function recalculatePension() {
    ...
    var pensionMax = 80000/pensionFrequecy;
    ...
    if (extinterest == 0 ) {
        ...
        var extinterest = 0.05 + extinterestPct/100;
    ...
    $('#scen-two-govpen-bar').animate({height: govpenHeightTwo}, 500);
    ...
    var govpenPensionOne = govpenYearsOne * (3220 / pensionFrequecy);
    var govpenPensionTwo = govpenYearsTwo * (3220 / pensionFrequecy);
    var govpenPensionThree = govpenYearsThree * (3220 / pensionFrequecy);


    // Update the labels / captions
    $('#demo-sc1-value').text(dollarFormat.format(scenOnePension + purchPension + govpenPensionOne));
    $('#demo-sc2-value').text(dollarFormat.format(scenTwoPension + purchPension + govpenPensionTwo));
    $('#demo-sc3-value').text(dollarFormat.format(scenThreePension + purchPension + govpenPensionThree));
