function recalculatePension() {
    ...
    var scenTwoPension = ( (pensionBaseline * pensionFrequecy) + extinterestTwo + ( (scenTwoAge - 55) * 3000 ) * raiseMultTwo ) / pensionFrequecy;
    var scenThreePension = ( (pensionBaseline * pensionFrequecy) + extinterestThree + ( (scenThreeAge - 55) * 3000 ) * raiseMultThree ) / pensionFrequecy;
