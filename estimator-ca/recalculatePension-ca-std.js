function recalculatePension() {
    ...
    var scenOnePension = ( (pensionBaseline * pensionFrequecy) + extinterestOne + ( (scenOneAge - 55) * 2900 ) * raiseMultOne ) / pensionFrequecy;
    var scenTwoPension = ( (pensionBaseline * pensionFrequecy) + extinterestTwo + ( (scenTwoAge - 55) * 2900 ) * raiseMultTwo ) / pensionFrequecy;
    var scenThreePension = ( (pensionBaseline * pensionFrequecy) + extinterestThree + ( (scenThreeAge - 55) * 2900 ) * raiseMultThree ) / pensionFrequecy;
